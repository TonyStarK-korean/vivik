...
**2️⃣ 조건 2: MA 패턴 (다음 중 하나)**
- **2A**: 60봉 이내 MA5-MA20 데드크로스
- **2B**: 10봉 이내 MA5-MA20 골든크로스
- **2C**: MA5<MA20 또는 MA5-MA20 이격도 2% 이내

**3️⃣ SuperTrend 신호**
- 3분봉 SuperTrend(10-3) 진입 시그널 필수

#### **1분봉 진입 타이밍:**
- MA5-MA120 골든크로스 발생 시 또는
- MA5-MA120 이격도 -1%~10% 범위 + 봉양봉 돌파 시
...
### 2단계: 4시간봉 급등 필터링
- 최근 4봉 중 시가대비 고가 **3% 이상** 급등 (2024년 11월 개선: 4%→3%)
- 4봉 이전~현재 모두 양봉
