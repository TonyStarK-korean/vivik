...
# 1. SSH 연결 및 디렉토리 생성
print("1. VPS에 SSH Connected 및 디렉토리 생성:")
...
print("   # 로그 Confirmed: tail -f trading.log")
print()

print("=== 업로드 Complete 후 Confirmed사항 ===")
print("1. API 키가 올바르게 Settings되었는지 Confirmed")
print("2. 네트워크 Connected 상태 Confirmed")
print("3. 프로그램이 정상 실행되는지 Confirmed")
print("4. 텔레그램 알림이 오는지 Confirmed")